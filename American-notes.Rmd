...
Hot cognition hypothesis: the claim that with repeated co-activation socio-political concepts become positively or negatively charged and this afftective charge becomes directly linked to the concepts in long-term memory. Thereupon 'feelings' come to mind spontaneouly upon mere activation of the object represented in long-term memory, be it a person, a group, an issue or an event ect.

Emotions come before rational judgements. Motivated reasoning exists. 

Affect-driven, dual-processing model. Seven postulates of JQP model.

1. Automaticity. What people think, feel, say and do is a direct funtion of the information that is mementarily accessible from memory. 

2. Hot cognition, feeling and affect is in the center stage of information processing.

3. Somatic embodiment of affect: connecting affect to attitudes, goals, choices and behaviors

4. the primacy of affect: affect before cognition

5. online updating of evaluation

6. affect transfer

7. affect contagion and motivated reasoner
...
## Political Knowledge Related



### Arthur Lupia 2016 Uninformed Voters

differences between information, competence and knowledge, competence is always with respect to a task and an evaluative criterion. An example will be a person's ability to choose a candidate for office that is most consistent with a relevant set of facts while also best aligning with a chosen set of values. Information is most valuable to an audience if it is necessary or sufficient to increase competence at high valued tasks. 

Information that matters: 1. sufficient and necessary to improve perfromance; 2. leaners may pay sufficient attention to.

Information is what educators can convey to others directly; knowledge is memories of how concepts and objects are related to one another. Knowledge requires information. 

The importance of values: influencing how people perceive and process information; drive individuals to embrace certain types of information and rejects others; values often have these effects before perspective learners are conscious of them, and they have these effects even if prospective learners have trouble describing them. 

attribution error; out-group stereotyping and motivated reasoning.

anes incorrect coding: Rehnquist as 'the head of the court'

## Motivated Reasoning and Affect

Sinclair and Kunda 1999
Druckman and Bolsen 2011
Jerit and Barabas 2012: self-identified partisans are more likely to recall facts that favor theri partisan priorties. 

Carpini and Keeter 1996 what Americans know about politics and why it matters. 

### Milton Lodge and Charles Taber 2013 The Rationalizing Voter

affect-driven and dual-processing model of political reasoning 

hints: face, appearance, age, gender, race, attrativeness, familarity. subliminal messages. 

both affective and congtive reactions to external and internal events are triggered unconsciously. 


### Lau and Redlawski 2006 How Voters Decid
